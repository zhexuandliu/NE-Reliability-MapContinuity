...
#' @param initial_dims Integer. The number of dimensions that should be retained in the initial PCA step.
...
#' @import RtsneWithP
#' @import parallel
perturbation_score_compute = function(X, Y, perplexity, length, approx, ind = NULL, no.cores = NULL, pca_center = TRUE, pca_scale = FALSE){
  if (approx){
